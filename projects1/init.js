! function(a) {
    ...
    eve = function(a, d) {
            ...
            for (m.sort(i); m[j] < 0;)
                if (e = n[m[j++]], o.push(e.apply(d, g)), c)
                    return c = f, o;
            for (q = 0; r > q; q++)
                if (e = h[q], "zIndex" in e)
                    if (e.zIndex == m[j]) {
                        if (o.push(e.apply(d, g)), c)
                            break;
                        do
                            if (j++, e = n[m[j]], e && o.push(e.apply(d, g)), c)
                                break;
                        while (e)
                    } else
                        n[e.zIndex] = e;
            else if (o.push(e.apply(d, g)), c)
                break;
            return c = f, b = p, o
        },
        eve._events = j,
...
function(a, b) {
                    ...
                    for (var g in d)
                        if (d.hasOwnProperty(g)) {
                            ...
                            h.s = (i - h.b) / (h.dur / h.spd),
                                h.s >= 1 && (delete d[g], h.s = 1, f--, function(a) {
                                    setTimeout(function() {
        ...
        d = function(a) {
            ...
            function d(a, b) {
                if (b) {
                    if ("#text" == a && (a = y.doc.createTextNode(b.text || b["#text"] || "")), "#comment" == a && (a = y.doc.createComment(b.text || b["#text"] || "")), "string" == typeof a && (a = d(a)), "string" == typeof b)
                        return 1 == a.nodeType ? "xlink:" == b.substring(0, 6) ? a.getAttributeNS(T, b.substring(6)) : "xml:" == b.substring(0, 4) ? a.getAttributeNS(U, b.substring(4)) : a.getAttribute(b) : "text" == b ? a.nodeValue : null;
                    if (1 == a.nodeType) {
                        for (var c in b)
                            if (b[z](c)) {
                                var e = A(b[c]);
            ...
            c.color = function(a) {
                ...
                c.hsb2rgb = function(a, b, c, d) {
                    e(a, "object") && "h" in a && "s" in a && "b" in a && (c = a.b, b = a.s, d = a.o, a = a.h),
                        a *= 360;
                    var f,
                        g,
                        h,
                ...
                c.parsePathString = function(a) {
                    ...
                    return e(a, "array") && e(a[0], "array") && (f = c.path.clone(a)), f.length || A(a).replace(N, function(a, b, c) {
                        ...
                        if (c.replace(P, function(a, b) {
                                b && e.push(+b)
                            }), "m" == g && e.length > 2 && (f.push([b].concat(e.splice(0, 2))), g = "l", b = "m" == b ? "l" : "L"), "o" == g && 1 == e.length && f.push([b, e[0]]), "r" == g)
                            f.push([b].concat(e));
                        else
    ...
    return d.plugin(function(c, d, e, f, g) {
        function h(a, b) {
            if (null == b) {
                var d = !0;
                if (b = "linearGradient" == a.type || "radialGradient" == a.type ? a.node.getAttribute("gradientTransform") : "pattern" == a.type ? a.node.getAttribute("patternTransform") : a.node.getAttribute("transform"), !b)
                    return new c.Matrix;
                b = c._.svgTransform2string(b)
            } else
                b = c._.rgTransform.test(b) ? m(b).replace(/\.{3}|\u2026/g, a._.transform || "") : c._.svgTransform2string(b),
                l(b, "array") && (b = c.path ? c.path.toString.call(b) : m(b)),
                a._.transform = b;
        ...
        function i(a) {
            function b(a, b) {
                ...
                d = d && d.match(g),
                    d = d && d[2],
                    d && "#" == d.charAt() && (d = d.substring(1), d && (i[d] = (i[d] || []).concat(function(d) {
                        var e = {};
                        e[b] = c.url(d),
                            o(a.node, e)
                    })))
        ...
        k.getBBox = function(a) {
            if ("tspan" == this.type)
                return c._.box(this.node.getClientRects().item(0));
            if (!c.Matrix || !c.path)
            ...
            for (;
                "use" == b.type;)
                if (a || (d = d.add(b.transform().localMatrix.translate(b.attr("x") || 0, b.attr("y") || 0))), b.original)
                    b = b.original;
                else {
        ...
        function i(a) {
            for (var b = [], c = a.childNodes, d = 0, e = c.length; e > d; d++) {
                ...
                3 == f.nodeType && b.push(f.nodeValue),
                    "tspan" == f.tagName && (1 == f.childNodes.length && 3 == f.firstChild.nodeType ? b.push(f.firstChild.nodeValue) : b.push(i(f)))
            }
            return b
        }
        ...
        a.deurl = function(a) {
            ...
            b.on("snap.util.attr.mask", function(a) {
                if (a instanceof c || a instanceof f) {
                    if (b.stop(), a instanceof f && 1 == a.node.childNodes.length && (a = a.node.firstChild, n(this).appendChild(a), a = l(a)), "mask" == a.type)
                        var d = a;
                    else
                        d = k("mask", n(this)),
            ...
            b.on("snap.util.attr.textpath", function(a) {
                if (b.stop(), "text" == this.type) {
                    ...
                    if (m(a, "string")) {
                        ...
                        a = l(a),
                        a instanceof c && (d = a.attr("id"), d || (d = a.id, a.attr({
                            id: d
                        })));
                    if (d)
        ...
        b.on("snap.util.attr", function(a) {
                ...
                if (c) {
                    ...
                    var h = c[3] || "",
                        m = f.match(k),
                        n = i[c[1]];
                    if (m && m == h ? a = n(parseFloat(f), +c[2]) : (f = this.asPX(e), a = n(this.asPX(e), this.asPX(e, c[2] + h))), isNaN(f) || isNaN(a))
                        return;
                    g[e] = a,
                        this.attr(g)
                }
        ...
        h.image = function(a, b, d, e, f) {
                ...
                if (i(a, "object") && "src" in a)
                    ...
                    null != b && null != d && (h.x = b, h.y = d),
                        null != e && null != f ? (h.width = e, h.height = f) : j(a, function() {
                            c._.$(g.node, {
            ...
            h.ptrn = function(a, b, c, d, e, f, g, h) {
                if (i(a, "object"))
                    ...
                    null != c && (j.width = c),
                    null != d && (j.height = d),
                    null != e && null != f && null != g && null != h ? j.viewBox = [e, f, g, h] : j.viewBox = [a || 0, b || 0, c || 0, d || 0];
            ...
            function() {
                ...
                function e(a, b) {
                    ...
                    for (var f, g = this.stops(), h = 0; h < g.length; h++) {
                        ...
                        if (i > b) {
                            this.node.insertBefore(d, g[h].node),
                                f = !0;
                            break
                        }
                    }
                ...
                function i(a, c) {
                    ...
                    e.params.unshift(a),
                        ...
                        e.type != e.type.toLowerCase() && l(d.node, {
                ...
                h.gradient = function(a) {
                    ...
                    h.clear = function() {
                        for (var a, b = this.node.firstChild; b;)
                            a = b.nextSibling,
                            "defs" != b.tagName ? b.parentNode.removeChild(b) : h.clear.call({
                                node: b
                            }),
                            b = a
                    }
                ...
                for (var h, j, l, m, n, o = "", p = {}, q = 0, r = 0, s = a.length; s > r; r++) {
                    if (l = a[r], "M" == l[0])
                        ...
                        if (m = i(h, j, l[1], l[2], l[3], l[4], l[5], l[6]), q + m > f) {
                            if (d && !p.start) {
                                if (n = i(h, j, l[1], l[2], l[3], l[4], l[5], l[6], f - q), o += ["C" + e(n.start.x), e(n.start.y), e(n.m.x), e(n.m.y), e(n.x), e(n.y)], g)
                                    return o;
                                p.start = o,
                            ...
                            if (!c && !d)
                                return n = i(h, j, l[1], l[2], l[3], l[4], l[5], l[6], f - q)
                        }
                        q += m,
                            h = +l[5],
                            j = +l[6]
            ...
            if (!(S(a, c) < R(e, g) || R(a, c) > S(e, g) || S(b, d) < R(f, h) || R(b, d) > S(f, h))) {
                ...
                if (k) {
                    var l = i / k,
                        ...
                        n = +l.toFixed(2),
                        o = +m.toFixed(2);
                    if (!(n < +R(a, c).toFixed(2) || n > +S(a, c).toFixed(2) || n < +R(e, g).toFixed(2) || n > +S(e, g).toFixed(2) || o < +R(b, d).toFixed(2) || o > +S(b, d).toFixed(2) || o < +R(f, h).toFixed(2) || o > +S(f, h).toFixed(2)))
                        return {
                            x: l,
                            y: m
                        }
        ...
        function s(a, b, c) {
            ...
            for (s = 0; h > s; s++)
                for (var u = 0; i > u; u++) {
                    ...
                    if (B) {
                        if (o[B.x.toFixed(4)] == B.y.toFixed(4))
                            continue;
        ...
        function z(a, b, c, d, e) {
            if (null == e && null == d && (d = c), a = +a, b = +b, c = +c, d = +d, null != e)
                var f = Math.PI / 180,
                    h = a + c * Math.cos(-d * f),
                    i = a + c * Math.cos(-e * f),
                    j = b + c * Math.sin(-d * f),
        ...
        function B(b) {
            ...
            if (c.abs)
                return h(c.abs);
            if (K(b, "array") && K(b && b[0], "array") || (b = a.parsePathString(b)), !b || !b.length)
                return [
                    ["M", 0, 0]
                ];
            var d,
        ...
        function F(a, b, c, d, e, f, g, h) {
            for (var i, j, k, l, m, n, o, p, q = [], r = [
                ...
                if (0 == s ? (j = 6 * a - 12 * c + 6 * e, i = -3 * a + 9 * c - 9 * e + 3 * g, k = 3 * c - 3 * a) : (j = 6 * b - 12 * d + 6 * f, i = -3 * b + 9 * d - 9 * f + 3 * h, k = 3 * d - 3 * b), U(i) < 1e-12) {
                    ...
                    o = j * j - 4 * k * i,
                    p = P.sqrt(o),
                    0 > o || (m = (-j + p) / (2 * i), m > 0 && 1 > m && q.push(m), n = (-j - p) / (2 * i), n > 0 && 1 > n && q.push(n));
        ...
        function G(a, b) {
            ...
            for (var d = B(a), f = b && B(b), g = {
                ...
                d[q] && (o = d[q][0]),
                    ...
                    "A" != m[q] && "C" == o && (m[q] = "C"),
                    k(d, q),
                    f && (f[q] && (o = f[q][0]), "C" != o && (n[q] = o, q && (p = n[q - 1])), f[q] = j(f[q], i, p), "A" != n[q] && "C" == o && (n[q] = "C"), k(f, q)),
                    l(d, f, g, i, q),
                    l(f, d, i, g, q);
                var s = d[q],
                    t = f && f[q],
        ...
        j.push = function() {
            ...
            j.animate = function(d, e, f, g) {
                "function" != typeof f || f.length || (g = f, f = c.linear),
                    d instanceof a._.Animation && (g = d.callback, f = d.easing, e = f.dur, d = d.attr);
                var h = arguments;
            ...
            j.splice = function(a, b, c) {
                a = 0 > a ? g(this.length + a, 0) : a,
                    b = g(0, h(this.length - a, b));
                var d,
                    e = [],
                    f = [],
                    j = [];
        ...
        p.stroke = p.fill = "colour",
            ...
            b.on("snap.util.equal", function(b, c) {
                var d,
                    ...
                    s = this;
                if ("colour" == p[b])
                    return d = a.color(f), e = a.color(c), {
                        from: [d.r, d.g, d.b, d.opacity],
                        to: [e.r, e.g, e.b, e.opacity],
                        f: k
                    };
                if ("viewBox" == b)
                    return d = this.attr(b).vb.split(" ").map(Number), e = c.split(" ").map(Number), {
                        from: d,
                        to: e,
                        f: j
                    };
                if ("transform" == b || "gradientTransform" == b || "patternTransform" == b)
                    return "string" == typeof c && (c = r(c).replace(/\.{3}|\u2026/g, f)), f = this.matrix, c = a._.rgTransform.test(c) ? a._.transform2matrix(c, this.getBBox()) : a._.transform2matrix(a._.svgTransform2string(c), this.getBBox()), g(f, c, function() {
                        return s.getBBox(1)
                    });
                if ("d" == b || "path" == b)
                    return d = a.path.toCubic(f, c), {
                        from: m(d[0]),
                        to: m(d[1]),
                        f: l(d[0])
                    };
                if ("points" == b)
                    return d = r(f).split(a._.separator), e = r(c).split(a._.separator), {
                        from: d,
                        to: e,
                        f: function(a) {
                            return a
        ...
        f.drag = function(c, d, e, f, g, h) {
                function i(i, j, l) {
                    (i.originalEvent || i).preventDefault(),
                        k._drag.x = j,
                        k._drag.y = l,
                        k._drag.id = i.identifier, !o.length && a.mousemove(p).mouseup(q),
                        o.push({
                            el: k,
                            move_scope: f,
                            start_scope: g,
    ...
    var b = /iPhone/i,
        ...
        r = function(a) {
            ...
            if ("undefined" != typeof s[1] && (r = s[0]), s = r.split("Twitter"), "undefined" != typeof s[1] && (r = s[0]), this.apple = {
                ...
                }, this.seven_inch = q(p, r), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch, this.phone = this.apple.phone || this.android.phone || this.windows.phone, this.tablet = this.apple.tablet || this.android.tablet || this.windows.tablet, "undefined" == typeof window)
                return this
        },
        s = function() {
            var a = new r;
...
(function(w, $) {
    w.Snap.plugin(function(Snap, Element, Paper, global) {
        Element.prototype.polyAnimate = function(destPoints, duration, easing, callback) {
            var poly = this;
            Snap.animate(this.attr('points'), destPoints, function(val) {
                poly.attr({
                    points: val
                })
    ...
    w.$ani = {
        ...
        setSMAnim: undefined,
        runWebPImgs: undefined,
        initCSAnims: undefined,
        loadProj: undefined,
        homeElemsAnim: undefined,
        liteAnims: undefined,
        getID: function(elem) {
    ...
    if (elm.style.vectorEffect !== undefined) {
        $('html').addClass('vectorEffect')
    } else {
        $('html').addClass('no-vectorEffect')
    }
    if ($('html').hasClass('index')) {
        url = "images/sprite.svg";
        for (var l = 1; l <= 3; l++) {
            var s = w.Snap("#introAnim" + l);
            s.line(40.2, 90.1, 40.2, 2.9).addClass("PLines1 PLines");
            s.line(2.5, 24.7, 78, 68.3).addClass("PLines1 PLines");
            s.line(78, 24.7, 40.2, 46.5).addClass("PLines1 PLines");
            s.line(104.1, 24.7, 141.8, 46.5).addClass("SLines");
            s.line(141.8, 2.9, 141.8, 46.5).addClass("SLines");
            s.line(104.1, 68.3, 141.8, 46.5).addClass("SLines");
            s.line(141.8, 90.1, 179.6, 68.3).addClass("SLines");
            s.line(141.8, 90.1, 179.6, 111.8).addClass("SLines");
            s.line(141.8, 90.1, 141.8, 133.6).addClass("SLines");
            s.polygon(40.2, 121.3, 40.2, 90.1, 78, 68.3, 78, 24.7, 40.2, 2.9, 2.5, 24.7, 2.5, 111.8, 40.2, 133.6);
            if (l % 2 == 0) {
                s.polygon(179.6, 96.5, 179.6, 111.8, 141.8, 133.6, 104.1, 111.8, 141.8, 90.1, 104.1, 68.3, 104.1, 24.7, 141.8, 2.9, 179.6, 24.7, 141.8, 46.5, 179.6, 68.3);
            } else {
                s.polygon(179.6, 82, 179.6, 68.3, 141.8, 46.5, 179.6, 24.7, 141.8, 2.9, 104.1, 24.7, 104.1, 68.3, 141.8, 90.1, 104.1, 111.8, 141.8, 133.6, 179.6, 111.8, 179.6, 96.5);
            }
        }
        var nextStrokeIndex = 0,
            timerVar;

        function loadHomeAnim() {
            if (w.$ani.homeElemsAnim === undefined) {
        ...
        var numOfIntroAnims = $(".introAnim svg").length + 1;

        function nextStroke() {
            nextStrokeIndex++;
            if (nextStrokeIndex === numOfIntroAnims) {
                loadHomeAnim()
            }
            new w.TimelineMax().staggerTo("#introAnim" + nextStrokeIndex, 0.3, {
                autoAlpha: 1,
                ease: Power3.easeIn
            }).staggerTo("#introAnim" + nextStrokeIndex + " polygon", 1.6, {
                strokeDashoffset: 0,
                ease: Power4.easeInOut
            }).add(TweenMax.staggerTo("#introAnim" + nextStrokeIndex + " .PLines", 0.5, {
                strokeDashoffset: 0,
                delay: 0.1,
                ease: Power2.easeInOut
            }, 0.5), 0.5).add(TweenMax.staggerTo("#introAnim" + nextStrokeIndex + " .SLines", 0.2, {
                strokeDashoffset: 0,
                delay: 0.1,
                ease: Power2.easeInOut
            }, 0.1), 0.8).addCallback(nextStroke, 0.6)
        }
        nextStroke();
    } else {
        url = "../images/sprite.svg"
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            div.setAttribute('style', 'visibility:hidden;width:0;height:0;');
    ...
    } else if (w.isMobile.phone) {
        $('html').addClass('mobile');
    }
})(window, $);
/*! modernizr 3.3.1 (Custom Build) | MIT *
 * https://new.modernizr.com/download/?-canvas-csscalc-cssfilters-cssvhunit-forcetouch-history-inlinesvg-objectfit-pagevisibility-svg-svgasimg-svgfilters-touchevents-webp-setclasses-testallprops !*/
;
! function(e, t, n) {
    function r(e, t) {
        return typeof e === t
        ...
        for (var l in C)
            if (C.hasOwnProperty(l)) {
                ...
                for (i = r(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++)
                    s = e[o],
                    a = s.split("."),
                    1 === a.length ? Modernizr[a[0]] = i : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = i),
                    w.push((i ? "" : "no-") + a.join("-"))
            }
    }
    ...
    function g(e, t, i, o) {
        function a() {
            A && (delete D.style, delete D.modElem)
        }
        ...
        for (var A, d, c, p, v, g = ["modernizr", "tspan", "samp"]; !D.style && g.length;)
            A = !0,
            D.modElem = s(g.shift()),
            D.style = D.modElem.style;
        for (c = e.length, d = 0; c > d; d++)
            if (p = e[d], v = D.style[p], f(p, "-") && (p = u(p)), D.style[p] !== n) {
                if (o || r(i, "undefined"))
                    return a(), "pfx" == t ? p : !0;
                try {
                    D.style[p] = i
    ...
    function m(e, t, n, i, o) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(a, t, i, o) : (a = (e + " " + P.join(s + " ") + s).split(" "), p(a, t, n))
    }
    ...
    var E = "CSS" in e && "supports" in e.CSS,
        R = "supportsCSS" in e;
    Modernizr.addTest("supports", E || R);
    var B;
    ! function() {
    ...
    var O = "Moz O ms Webkit",
        U = _._config.usePrefixes ? O.split(" ") : [];
    _._cssomPrefixes = U;
    var Q = function(t) {
        var r,
            i = x.length,
    ...
    _.atRule = Q;
    var P = _._config.usePrefixes ? O.toLowerCase().split(" ") : [];
    _._domPrefixes = P;
    ...
    Modernizr._q.unshift(function() {
        ...
        Modernizr.addTest("cssfilters", function() {
            ...
            var e = s("a");
            return e.style.cssText = x.join("filter:blur(2px); "), !!e.style.length && (t.documentMode === n || t.documentMode > 9)
        });
    var M = _.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? Q(e) : (-1 != e.indexOf("-") && (e = u(e)), t ? m(e, t, n) : m(e, "pfx"))
    };
    Modernizr.addTest("forcetouch", function() {
            return b(M("mouseforcewillbegin", e, !1), e) ? MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN && MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN : !1
        }),
        Modernizr.addTest("pagevisibility", !!M("hidden", t, !1)),
