(function() {
    ...
    var n = window.Element.prototype,
        ia = n.matches || n.matchesSelector || n.webkitMatchesSelector || n.mozMatchesSelector || n.msMatchesSelector || n.oMatchesSelector;
    ...
    function p(a, b, c) {
        function d(a) {
            ...
            if (h.composed && "function" == typeof a.composedPath)
                for (var e = a.composedPath(), g = 0, E; E = e[g]; g++)
                    1 == E.nodeType && ja(E, b) && (d = E);
            else
                a: {
    ...
    oa.prototype.j = function() {
        ...
        1 < a && (u.splice(a, 1), this.c ? this.context.set(this.P, this.f) : this.context[this.P] = this.f)
    };
    ...
    function wa(a, b) {
        ...
        d = {
            page: d + (a.a.stripQuery ? "" : c.search)
        };
        b.location && (d.location = b.location);
        a.b && (d[a.b] = c.search.slice(1) || "(not set)");
        return "function" == typeof a.a.urlFieldsFilter ? (b = a.a.urlFieldsFilter(d, t), c = {}, c.page = b.page, c.location = b.location, c[a.b] = b[a.b], c) : d
    }
    I.prototype.remove = function() {
        w(this.i, "get", this.f);
        w(this.i, "buildHitTask", this.c)
    };
    C("cleanUrlTracker", I);
    ...
    J.prototype.c = function(a, b) {
        ...
        if (!(0 > b.getAttribute(c + "on").split(/\s*,\s*/).indexOf(a.type))) {
            var c = z(b, c),
                d = y({}, this.a.fieldsObj, c);
            this.f.send(c.hitType || "event", x({
                transport: "beacon"
    ...
    function xa(a, b) {
        var c = this;
        H(a, F.V);
        window.IntersectionObserver && window.MutationObserver && (this.a = y({
            rootMargin: "0px",
            fieldsObj: {},
            attributePrefix: "ga-"
        }, b), this.c = a, this.M = this.M.bind(this), this.O = this.O.bind(this), this.K = this.K.bind(this), this.L = this.L.bind(this), this.b = null, this.items = [], this.h = {}, this.g = {}, sa(function() {
    ...
    f.observeElements = function(a) {
        ...
        a.items.forEach(function(a) {
            var c = b.g[a.threshold] = b.g[a.threshold] || new IntersectionObserver(b.O, {
        ...
        for (var b = [], c = 0, d; d = a[c]; c++)
            for (var e = 0, h; h = this.items[e]; e++) {
                ...
                if (g = d.target.id === h.id)
                    (g = h.threshold) ? g = d.intersectionRatio >= g : (g = d.intersectionRect, g = 0 < g.top || 0 < g.bottom || 0 < g.left || 0 < g.right);
                if (g) {
                    var D = h.id;
                    ...
                    var D = {
                        ...
                        Ia = y({}, this.a.fieldsObj, z(g, this.a.attributePrefix));
                    this.c.send("event", x(D, Ia, this.c, this.a.hitFilter, g));
    ...
    function Q(a, b, c) {
        ...
        M[a] || (M[a] = new P(a, c), N || (window.addEventListener("storage", Ba), N = !0));
        return M[a]
    }
    ...
    P.prototype.get = function() {
        ...
        return this.l = y({}, this.w, this.l)
    };
    P.prototype.set = function(a) {
        this.l = y({}, this.w, this.l, a);
        if (R())
            try {
    ...
    P.prototype.j = function() {
        delete M[this.b];
        Object.keys(M).length || (window.removeEventListener("storage", Ba), N = !1)
    };

    function Ba(a) {
        var b = M[a.key];
        if (b) {
            var c = y({}, b.w, S(a.oldValue));
            a = y({}, b.w, S(a.newValue));
            b.l = a;
    ...
    function T(a, b, c) {
        ...
        v(a, "sendHitTask", this.b);
        try {
            this.c = new Intl.DateTimeFormat("en-US", {
                timeZone: this.timeZone
            })
        } catch (d) {}
        this.a = Q(a.get("trackingId"), "session", {
            hitTime: 0,
            isExpired: !1
        })
    }
    T.prototype.isExpired = function(a) {
        ...
        return a && (b - c > 6E4 * this.timeout || this.c && this.c.format(b) != this.c.format(c)) ? !0 : !1
    };
    ...
    T.prototype.j = function() {
        w(this.f, "sendHitTask", this.b);
        this.a.j();
        delete Da[this.f.get("trackingId")]
    };
    var U = 30;

    function V(a, b) {
        H(a, F.W);
        window.addEventListener && (this.a = y({
            increaseThreshold: 20,
            sessionTimeout: U,
            fieldsObj: {}
        }, b), this.c = a, this.b = Ea(this), this.f = ta(this.f.bind(this), 500), this.m = this.m.bind(this), this.i = Q(a.get("trackingId"), "plugins/max-scroll-tracker"), this.s = new T(a, this.a.sessionTimeout, this.a.timeZone), v(a, "set", this.m), Fa(this))
    }
    ...
    V.prototype.f = function() {
        ...
        if (this.s.isExpired())
            Ca(this.i);
        else if (b = this.i.get()[this.b] || 0, a > b && (100 != a && 100 != b || window.removeEventListener("scroll", this.f), b = a - b, 100 == a || b >= this.a.increaseThreshold)) {
            var c = {};
            ...
            this.c.send("event", x(a, this.a.fieldsObj, this.c, this.a.hitFilter))
        }
    };
    V.prototype.m = function(a) {
        ...
        return function(c, d) {
            a(c, d);
            var e = {};
            (B(c) ? c : (e[c] = d, e)).page && (c = b.b, b.b = Ea(b), b.b != c && Fa(b))
        }
    };
    ...
    function W(a, b) {
        H(a, F.X);
        window.matchMedia && (this.a = y({
            changeTemplate: this.changeTemplate,
            changeTimeout: 1E3,
            fieldsObj: {}
        }, b), B(this.a.definitions) && (b = this.a.definitions, this.a.definitions = Array.isArray(b) ? b : [b], this.b = a, this.c = [], Ha(this)))
    }
        ...
        b.items.forEach(function(c) {
            ...
            var d = ta(function() {
                ...
                c !== d && (a.b.set("dimension" + b.dimensionIndex, c), c = {
                    ...
                    nonInteraction: !0
                }, a.b.send("event", x(c, a.a.fieldsObj, a.b, a.a.hitFilter)))
            }, a.a.changeTimeout);
            c.addListener(d);
            a.c.push({
                fa: c,
    ...
    function La(a) {
        return Ga[a] || (Ga[a] = window.matchMedia(a))
    }
    ...
    function X(a, b) {
        ...
        window.addEventListener && (this.a = y({
            ...
            fieldsObj: {},
            attributePrefix: "ga-"
        }, b), this.b = a, this.c = p("submit", this.a.formSelector, this.f.bind(this)))
    }
    X.prototype.f = function(a, b) {
        ...
        if (this.a.shouldTrackOutboundForm(b, t)) {
            navigator.sendBeacon || (a.preventDefault(), c.hitCallback = ua(function() {
                b.submit()
            }));
            var d = y({}, this.a.fieldsObj, z(b, this.a.attributePrefix));
            this.b.send("event", x(c, d, this.b, this.a.hitFilter, b, a))
        }
    };
    ...
    function Y(a, b) {
        ...
        window.addEventListener && (this.a = y({
            ...
            fieldsObj: {},
            attributePrefix: "ga-"
        }, b), this.f = a, this.c = this.c.bind(this), this.b = {}, this.a.events.forEach(function(a) {
    ...
    Y.prototype.c = function(a, b) {
        if (this.a.shouldTrackOutboundLink(b, t)) {
            ...
            navigator.sendBeacon || "click" != a.type || "_blank" == b.target || a.metaKey || a.ctrlKey || a.shiftKey || a.altKey || 1 < a.which || window.addEventListener("click", function(a) {
                a.defaultPrevented || (a.preventDefault(), e.hitCallback = ua(function() {
                    location.href = c
                }))
            });
            d = y({}, this.a.fieldsObj, z(b, this.a.attributePrefix));
    ...
    var Z = function Ma(b) {
        return b ? (b ^ 16 * Math.random() >> b / 4).toString(16) : "10000000-1000-4000-8000-100000000000".replace(/[018]/g, Ma)
    }();

    function Na(a, b) {
        var c = this;
        H(a, F.$);
        document.visibilityState && (this.a = y({
            sessionTimeout: U,
            visibleThreshold: 5E3,
            sendInitialPageview: !1,
            fieldsObj: {}
        }, b), this.b = a, this.i = this.f = null, this.s = !1, this.v = this.v.bind(this), this.o = this.o.bind(this), this.G = this.G.bind(this), this.N = this.N.bind(this), this.c = Q(a.get("trackingId"), "plugins/page-visibility-tracker"), Aa(this.c, this.N), this.m = new T(a, this.a.sessionTimeout, this.a.timeZone), v(a, "set", this.v), window.addEventListener("unload", this.G), document.addEventListener("visibilitychange", this.o), this.o(), va(this.b, function() {
            if ("visible" == document.visibilityState)
                c.a.sendInitialPageview && (Oa(c, {
                    ea: !0
                }), c.s = !0);
                ...
                c.b.send("event", x(a, c.a.fieldsObj, c.b, c.a.hitFilter))
            }
        }))
    }
    f = Na.prototype;
    f.o = function() {
        ...
        if ("visible" == document.visibilityState || "hidden" == document.visibilityState) {
            var b = Pa(this, this.c.get()),
                c = {
                    time: +new Date,
                    state: document.visibilityState,
                    pageId: Z
                };
            this.f && "visible" == document.visibilityState && this.a.sendInitialPageview && !this.s && (Oa(this), this.s = !0);
            this.i && "hidden" == document.visibilityState && clearTimeout(this.i);
            this.m.isExpired() ? "hidden" == this.f && "visible" == document.visibilityState ? (clearTimeout(this.i), this.i = setTimeout(function() {
                a.c.set(c);
                Oa(a, {
                    hitTime: c.time
                })
            }, this.a.visibleThreshold)) : "hidden" == document.visibilityState && Ca(this.c) : (b.pageId == Z && "visible" == b.state && Qa(this, b), this.c.set(c));
            this.f = document.visibilityState
        }
    };

    function Pa(a, b) {
        "visible" == a.f && "hidden" == b.state && b.pageId != Z && (b.state = "visible", b.pageId = Z, a.c.set(b));
        return b
    }
    ...
    function Qa(a, b, c) {
        ...
        var d = {
            ...
            d = (d ? d : {}).hitTime;
        (b = b.time && !a.m.isExpired() ? (d || +new Date) - b.time : 0) && b >= a.a.visibleThreshold && (b = Math.round(b / 1E3), d = {
            transport: "beacon",
            nonInteraction: !0,
            ...
            eventValue: b,
            eventLabel: "(not set)"
        }, c && (d.queueTime = +new Date - c), a.a.visibleMetricIndex && (d["metric" + a.a.visibleMetricIndex] = b), a.b.send("event", x(d, a.a.fieldsObj, a.b, a.a.hitFilter)))
    }
    ...
    function Oa(a, b) {
        ...
        a.b.send("pageview", x(d, a.a.fieldsObj, a.b, a.a.hitFilter))
    }
    f.v = function(a) {
        var b = this;
        return function(c, d) {
            var e = {},
                e = B(c) ? c : (e[c] = d, e);
            e.page && e.page !== b.b.get("page") && "visible" == b.f && b.o();
            a(c, d)
        }
    };
    f.N = function(a, b) {
        a.time != b.time && b.pageId == Z && "visible" == b.state && Qa(this, b, {
            hitTime: a.time
        })
    };
    f.G = function() {
    ...
    f.D = function(a) {
        if ("tweet" == a.region) {
            ...
            this.b.send("social", x(b, this.a.fieldsObj, this.b, this.a.hitFilter, a.target, a))
        }
    };
    f.A = function(a) {
        if ("follow" == a.region) {
    ...
    C("socialWidgetTracker", Ra);

    function Ta(a, b) {
        H(a, F.ba);
        history.pushState && window.addEventListener && (this.a = y({
            shouldTrackUrlChange: this.shouldTrackUrlChange,
            trackReplaceState: !1,
            fieldsObj: {},
            hitFilter: null
        }, b), this.b = a, this.c = location.pathname + location.search, this.H = this.H.bind(this), this.I = this.I.bind(this), this.C = this.C.bind(this), v(history, "pushState", this.H), v(history, "replaceState", this.I), window.addEventListener("popstate", this.C))
    }
    f = Ta.prototype;
    f.H = function(a) {
        var b = this;
    ...
    function Ua(a, b) {
        setTimeout(function() {
            ...
            }), (b || a.a.trackReplaceState) && a.b.send("pageview", x({
                transport: "beacon"
